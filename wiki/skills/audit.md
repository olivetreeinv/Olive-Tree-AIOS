...
## What it does
Scores the AIOS against the Four Cs framework (Context, Connections, Capabilities, Cadence) — 25 points each, 100 total. Surfaces the top 3 leverage-weighted gaps with concrete fix commands.
...
- "score my setup against the Four Cs"
