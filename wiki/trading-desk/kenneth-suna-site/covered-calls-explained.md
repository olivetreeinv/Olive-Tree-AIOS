...
- ⚠️ **UNSOURCED — corrected 2026-07-31.** This bullet previously read: *"Best CSP timing (his view): right after a dramatic selloff. Stock falls $50 → $38 on bad news… sell a $37-strike CSP… post-selloff consolidation around $38 = downside largely done."* **Only the quoted sentence below is his.** A grep of all 52 raw transcripts for selloff/crash/panic/fear/VIX/correction returns **zero hits** — the $50→$38→$37 example and the "downside largely done" read were this summary's invention, and they propagated into the Premium Desk v3 spec as a build item. The corpus argues the **other** way: four videos on why he skips CSPs (`7UFks7QD7mc` premium too small for the collateral, `Sf5_PcOCqcM` can't exercise early so you miss the dip, `18mo5UwZkq0` weekend gap risk, `dlszkNZZNpA`/`MDBy-6aGw3A` reserved cash strangling weekly income at $15k and $17k). His one documented CSP was sold **into earnings near the highs** (`UlYufCzOC18`) and produced `T7wgeMJSGoQ` — "I made a huge covered call mistake."
  - Verbatim, and all that is: *"High premiums don't exist because everyone thinks the stock is safe. High premiums exist because everyone is worried it isn't."*
  - What he **does** state about strike choice: *"I would like to buy HIMS at a discount. It's currently around 64. I'm willing to buy it at 57"* — strike = the price you'd genuinely want to own it at (`T7wgeMJSGoQ`).
